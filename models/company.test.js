...
describe("findAll", function () {
  ...
  test("minEmployees > maxEmployees = BAD", async function (){
    try{
  ...
  test("works: empty list", async function (){
    let companies = await Company.findAll({ name: "empty" });
    expect(companies).toEqual([]);
  });
    ...
    expect(company).toEqual(
      {
        ...
        numEmployees: 1,
        logoUrl: 'http://c1.img',
        jobs: [ { id: 1, title: 't1', salary: 100, equity: '0.1' } ]
      }
    );
  });
